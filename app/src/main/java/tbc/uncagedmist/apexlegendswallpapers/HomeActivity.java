...
import tbc.uncagedmist.apexlegendswallpapers.Fragments.CategoryFragment;
import tbc.uncagedmist.apexlegendswallpapers.Fragments.FavouriteFragment;
import tbc.uncagedmist.apexlegendswallpapers.Fragments.PopularFragment;
import tbc.uncagedmist.apexlegendswallpapers.Fragments.RecentFragment;
import tbc.uncagedmist.apexlegendswallpapers.Utility.CurvedBottomNavigationView;
...
public class HomeActivity extends AppCompatActivity
    ...
    private void shareApp() {
        ...
        String message = "Amazing Wallpaper in your way. Install Game Wallpaper App and Make your Display look Colourful! \n https://play.google.com/store/apps/details?id=tbc.uncagedmist.apexlegendswallpapers";
        intent.putExtra(Intent.EXTRA_TEXT, message);
        startActivity(Intent.createChooser(intent, "Share Valorant Wallpapers App Using"));
    }
